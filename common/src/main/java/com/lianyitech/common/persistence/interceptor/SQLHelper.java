 ...
 * 
 */
package com.lianyitech.common.persistence.interceptor;

import com.lianyitech.common.persistence.Page;
import com.lianyitech.common.persistence.dialect.Dialect;
import com.lianyitech.common.utils.Reflections;
...
//        final String countSql = "select count(1) " + removeSelect(removeOrders(sql));
        ...
        try {
            ...
            if (Reflections.getFieldValue(boundSql, "additionalParameters") != null) {
                Map<String, Object> adparam = (Map<String, Object>) Reflections.getFieldValue(boundSql, "additionalParameters");
                Reflections.setFieldValue(countBS, "additionalParameters", adparam);
            }
