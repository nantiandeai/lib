...
/**
 * Created by jordan jiang on 2017/3/6.
 */
public class DownLoadPic {
    ...
    private static void downloadImg(String url) {
        ...
        try {
            String imageName = "/opt/crawler/img/" + url.substring(url.lastIndexOf("/") + 1,
                    url.length());
    ...
    public static void main(String[] args) throws  Exception{
        ...
        DownLoadPic.downloadImg("http://img.wl.cn/s/1988/8131988/8131988.jpg");
    }
